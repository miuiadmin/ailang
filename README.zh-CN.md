...
[![Status: Pre-Alpha](https://img.shields.io/badge/status-Pre--Alpha-orange.svg)](#状态)
...
完整设计合并为单一文档：[`docs/AILANG.md`](./docs/AILANG.md)（v0.2.1，冻结），分六个 Part：

- [Part 0 · 前言与动机](./docs/AILANG.md#part-0)
- [Part I · 语言规范](./docs/AILANG.md#part-i) —— 权威规范（含所有权与并发深解）
- [Part II · 标准库与包生态](./docs/AILANG.md#part-ii)
- [Part III · 教程：可运行示例](./docs/AILANG.md#part-iii)
- [Part IV · 编译器实现设计](./docs/AILANG.md#part-iv)
- [Part V · 决议记录](./docs/AILANG.md#part-v)

> 第一次了解？从 [Part 0](./docs/AILANG.md#part-0) 读起，再到 [Part I](./docs/AILANG.md#part-i) 规范。
